This Bass Synth is basically a single voice synth that can be powered by 5V USB.</br>
I am achieving this by faking a bi-polar sypply by first, boosting the 5V to 10V using a boost converter.</br>
Mid-rail voltage is 5V generated using a 7905 (not 7805!! ) negative voltage regulator.</br>
...
A Demo for the Synth and its build process is on Instagram (might do a youtube vid soon ;) ).</br>
